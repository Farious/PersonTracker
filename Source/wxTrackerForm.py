...
class TrackerMainFrame(wx.Frame):
    def __init__(self, parent):
        ...
        self.rewBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                      wx.BU_AUTODRAW)
        playerBtnBox.Add(self.rewBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.prevFrameBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                            wx.DefaultSize, wx.BU_AUTODRAW)
        playerBtnBox.Add(self.prevFrameBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.stopBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                       wx.BU_AUTODRAW)
        playerBtnBox.Add(self.stopBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.playBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                       wx.BU_AUTODRAW)
        playerBtnBox.Add(self.playBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.pauseBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                        wx.BU_AUTODRAW)
        playerBtnBox.Add(self.pauseBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.nextFrameBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                            wx.DefaultSize, wx.BU_AUTODRAW)
        playerBtnBox.Add(self.nextFrameBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.forwardBtn = wx.BitmapButton(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                          wx.BU_AUTODRAW)
        playerBtnBox.Add(self.forwardBtn, 1, wx.ALL | wx.EXPAND, 5)

        playerBox.Add(playerBtnBox, 1, wx.EXPAND, 5)

        trackerSizer.Add(playerBox, 3, wx.ALL | wx.EXPAND, 5)
        ...
        self.personCheckList = wx.CheckListBox(self.trackerTab, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                               personCheckListChoices, wx.LB_ALWAYS_SB)
        ...
        videoChkListChoices = []
        self.videoChkList = wx.CheckListBox(self.trackerTab, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                            videoChkListChoices, wx.LB_ALWAYS_SB)
        ...
        self.m_bitmap1 = wx.StaticBitmap(self.trackerTab, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                         0)
        statBox.Add(self.m_bitmap1, 1, wx.ALL | wx.EXPAND, 5)

        expansionBox.Add(statBox, 8, wx.ALL | wx.EXPAND, 5)

        trackerSizer.Add(expansionBox, 1, wx.ALL | wx.EXPAND, 5)
