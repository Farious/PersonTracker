...
class TrackerMainFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(743, 525), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)

        bSizer7 = wx.BoxSizer(wx.VERTICAL)

        self.notebookPanel = wx.aui.AuiNotebook(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                                wx.aui.AUI_NB_TAB_SPLIT)
        self.trackerTab = wx.Panel(self.notebookPanel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        bSizer8 = wx.BoxSizer(wx.HORIZONTAL)

        self.m_splitter2 = wx.SplitterWindow(self.trackerTab, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                             wx.SP_BORDER)
        ...
        self.rewBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                      wx.BU_AUTODRAW)
        playerBtnBox.Add(self.rewBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.prevFrameBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                            wx.DefaultSize, wx.BU_AUTODRAW)
        playerBtnBox.Add(self.prevFrameBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.stopBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                       wx.BU_AUTODRAW)
        playerBtnBox.Add(self.stopBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.playBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                       wx.BU_AUTODRAW)
        playerBtnBox.Add(self.playBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.pauseBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                        wx.BU_AUTODRAW)
        playerBtnBox.Add(self.pauseBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.nextFrameBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                            wx.DefaultSize, wx.BU_AUTODRAW)
        playerBtnBox.Add(self.nextFrameBtn, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)

        self.forwardBtn = wx.BitmapButton(self.m_panel14, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
                                          wx.BU_AUTODRAW)
        ...
        self.personCheckList = wx.CheckListBox(self.m_panel11, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
        ...
        videoChkListChoices = []
        self.videoChkList = wx.CheckListBox(self.m_panel11, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.m_checkBox2 = wx.CheckBox(self.m_panel11, wx.ID_ANY, u"Show frames with selected detections",
